...
public class CmdClientModule extends RpcModule {
    ...
    public boolean doStart() {
        System.out.println("waiting datt-wallet base module ready");
        ThreadUtils.createAndRunThread("", () -> {
            while (true) {
                ...
                if (waiting > 59) {
                    Log.error("waiting datt-wallet base module ready timeout ");
                    System.exit(0);
                }
            }
        });
    ...
    public RpcModuleState onDependenciesReady() {
        System.out.println("datt-wallet base module ready");
